  ...
  useEffect(() => {
    ...
    const newPlayers = currentPlayers.map((p) => {
      ...
      if (p.type !== newType) {
        ...
        newName = isHuman ? `${colorName} Player` : `${colorName} AI`;
      }
  ...
  return (
    <Card className="w-full max-w-lg shadow-2xl">
      <CardHeader>
        ...
        <CardDescription>
          Configure your Ludo match before you start.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {/* Human Player Color (only for vs-computer) */}
            {gameMode === "vs-computer" && (
              <FormField
                control={form.control}
                        ...
                        <FormItem>
                          <div className="flex items-center gap-2">
                            ...
                            <FormControl>
                              <Input
                                {...nameField}
                                placeholder={`${field.color} player name`}
                              />
                            </FormControl>
                          </div>
                          <FormMessage />
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="2000">2 seconds (default)</SelectItem>
