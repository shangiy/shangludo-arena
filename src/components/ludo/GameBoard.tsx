    ...
    const getCellContent = (index: number) => {
        ...
        if (isPath) {
            ...
            return <div className={cn(borderClasses, bgColor, "relative h-full w-full")}>
              ...
              {showSecondarySafepoints && p(x,y) === SECONDARY_YELLOW_SAFE_ZONE && <StarIcon color="red" />}
              {showSecondarySafepoints && p(x,y) === SECONDARY_RED_SAFE_ZONE && <StarIcon color="green" />}
              {showSecondarySafepoints && p(x,y) === SECONDARY_BLUE_SAFE_ZONE && <StarIcon color="yellow" />}
              {showSecondarySafepoints && p(x,y) === SECONDARY_GREEN_SAFE_ZONE && <StarIcon color="yellow" />}
            </div>;
        }
